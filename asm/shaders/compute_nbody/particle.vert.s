...
%projectedCorner = OpVariable %_ptr_Function_v4float Function
         ...
         %63 = OpAccessChain %_ptr_Uniform_float %ubo %int_2 %uint_0
         %64 = OpLoad %float %63
         %65 = OpAccessChain %_ptr_Function_float %projectedCorner %uint_0
         %66 = OpLoad %float %65
         %67 = OpFMul %float %64 %66
         %68 = OpAccessChain %_ptr_Function_float %projectedCorner %uint_3
         %69 = OpLoad %float %68
         %70 = OpFDiv %float %67 %69
         %72 = OpExtInst %float %1 FClamp %70 %float_1 %float_128
         %74 = OpAccessChain %_ptr_Output_float %_ %int_1
               OpStore %74 %72
         %75 = OpAccessChain %_ptr_Uniform_mat4v4float %ubo %int_0
         %76 = OpLoad %mat4v4float %75
         %77 = OpLoad %v4float %eyePos
         %78 = OpMatrixTimesVector %v4float %76 %77
         %80 = OpAccessChain %_ptr_Output_v4float %_ %int_0
               OpStore %80 %78
         %83 = OpAccessChain %_ptr_Input_float %inVel %uint_3
         %84 = OpLoad %float %83
               OpStore %outGradientPos %84
               OpReturn
               OpFunctionEnd
