...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpEntryPoint Fragment %main "main" %inUVW %inInvModelView %inViewVec %inNormal %inLightVec %outColor0 %inPos
...
%float_0_0722000003 = OpConstant %float 0.0722000003
        %216 = OpConstantComposite %v3float %float_0_212599993 %float_0_715200007 %float_0_0722000003
 ...
 %wViewVec_0 = OpVariable %_ptr_Function_v3float Function
  ...
  %threshold = OpVariable %_ptr_Function_float Function
        ...
        %196 = OpVectorTimesScalar %v3float %195 %float_1
        %197 = OpExtInst %v3float %1 Exp %196
        %198 = OpFSub %v3float %192 %197
        %202 = OpAccessChain %_ptr_Output_float %outColor0 %uint_0
        %203 = OpCompositeExtract %float %198 0
               OpStore %202 %203
        %205 = OpAccessChain %_ptr_Output_float %outColor0 %uint_1
        %206 = OpCompositeExtract %float %198 1
               OpStore %205 %206
        %208 = OpAccessChain %_ptr_Output_float %outColor0 %uint_2
        %209 = OpCompositeExtract %float %198 2
               OpStore %208 %209
        %211 = OpLoad %v4float %outColor0
        %212 = OpVectorShuffle %v3float %211 %211 0 1 2
        %217 = OpDot %float %212 %216
               OpStore %l %217
