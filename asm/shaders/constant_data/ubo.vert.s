...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpDecorate %mvp_uniform DescriptorSet 0
               OpDecorate %mvp_uniform Binding 1
...
%_ptr_Uniform_MVPUniform = OpTypePointer Uniform %MVPUniform
%mvp_uniform = OpVariable %_ptr_Uniform_MVPUniform Uniform
        %int = OpTypeInt 32 1
...
%_ptr_Output_gl_PerVertex = OpTypePointer Output %gl_PerVertex
      ...
      %int_1 = OpConstant %int 1
       %main = OpFunction %void None %3
          %5 = OpLabel
         %17 = OpAccessChain %_ptr_Uniform_mat4v4float %mvp_uniform %int_0
         ...
         %34 = OpLoad %v2float %texcoord_0
               OpStore %o_uv %34
         %37 = OpAccessChain %_ptr_Uniform_mat4v4float %mvp_uniform %int_0
         ...
         %49 = OpMatrixTimesVector %v3float %46 %48
               OpStore %o_normal %49
         %54 = OpAccessChain %_ptr_Uniform_mat4v4float %mvp_uniform %int_1
