...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %Addresses "Addresses"
               OpMemberName %Addresses 0 "command_buffer"
               ...
               OpName %addresses "addresses"
               OpName %VkDrawIndexedIndirectCommand_0 "VkDrawIndexedIndirectCommand"
               OpMemberName %VkDrawIndexedIndirectCommand_0 0 "indexCount"
               OpMemberName %VkDrawIndexedIndirectCommand_0 1 "instanceCount"
               OpMemberName %VkDrawIndexedIndirectCommand_0 2 "firstIndex"
               OpMemberName %VkDrawIndexedIndirectCommand_0 3 "vertexOffset"
               OpMemberName %VkDrawIndexedIndirectCommand_0 4 "firstInstance"
               OpName %CommandBuffer_0 "CommandBuffer"
               OpMemberName %CommandBuffer_0 0 "commands"
               ...
               OpDecorate %ModelInformationBuffer Block
               ...
               OpDecorate %CommandBuffer Block
               OpDecorate %addresses DescriptorSet 0
               OpDecorate %addresses Binding 4
               OpDecorate %gl_WorkGroupSize BuiltIn WorkgroupSize
               OpMemberDecorate %VkDrawIndexedIndirectCommand_0 0 Offset 0
               OpMemberDecorate %VkDrawIndexedIndirectCommand_0 1 Offset 4
               OpMemberDecorate %VkDrawIndexedIndirectCommand_0 2 Offset 8
               OpMemberDecorate %VkDrawIndexedIndirectCommand_0 3 Offset 12
               OpMemberDecorate %VkDrawIndexedIndirectCommand_0 4 Offset 16
               OpDecorate %_runtimearr_VkDrawIndexedIndirectCommand_0 ArrayStride 20
               OpMemberDecorate %CommandBuffer_0 0 Offset 0
               OpDecorate %CommandBuffer_0 Block
               OpDecorate %command_buffer DescriptorSet 0
               OpDecorate %command_buffer Binding 0
       %void = OpTypeVoid
...
%_ptr_StorageBuffer_ModelInformationBuffer = OpTypePointer StorageBuffer %ModelInformationBuffer
%model_buffer = OpVariable %_ptr_StorageBuffer_ModelInformationBuffer StorageBuffer
      %int_0 = OpConstant %int 0
%_ptr_StorageBuffer_ModelInformation_0 = OpTypePointer StorageBuffer %ModelInformation_0
...
%_ptr_Uniform_mat4v4float = OpTypePointer Uniform %mat4v4float
               OpTypeForwardPointer %_ptr_PhysicalStorageBuffer_CommandBuffer PhysicalStorageBuffer
  %Addresses = OpTypeStruct %_ptr_PhysicalStorageBuffer_CommandBuffer
...
%_ptr_PhysicalStorageBuffer_CommandBuffer = OpTypePointer PhysicalStorageBuffer %CommandBuffer
%_ptr_StorageBuffer_Addresses = OpTypePointer StorageBuffer %Addresses
  %addresses = OpVariable %_ptr_StorageBuffer_Addresses StorageBuffer
%_ptr_StorageBuffer__ptr_PhysicalStorageBuffer_CommandBuffer = OpTypePointer StorageBuffer %_ptr_PhysicalStorageBuffer_CommandBuffer
%_ptr_PhysicalStorageBuffer_uint = OpTypePointer PhysicalStorageBuffer %uint
    %uint_64 = OpConstant %uint 64
     %uint_1 = OpConstant %uint 1
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_64 %uint_1 %uint_1
%VkDrawIndexedIndirectCommand_0 = OpTypeStruct %uint %uint %uint %int %uint
%_runtimearr_VkDrawIndexedIndirectCommand_0 = OpTypeRuntimeArray %VkDrawIndexedIndirectCommand_0
%CommandBuffer_0 = OpTypeStruct %_runtimearr_VkDrawIndexedIndirectCommand_0
%_ptr_StorageBuffer_CommandBuffer_0 = OpTypePointer StorageBuffer %CommandBuffer_0
%command_buffer = OpVariable %_ptr_StorageBuffer_CommandBuffer_0 StorageBuffer
 ...
 %is_visible = OpVariable %_ptr_Function_bool Function
    ...
    %param_1 = OpVariable %_ptr_Function_float Function
        ...
        %134 = OpLabel
        %145 = OpLoad %uint %id
        %147 = OpAccessChain %_ptr_StorageBuffer_ModelInformation_0 %model_buffer %int_0 %145
        ...
        %196 = OpAccessChain %_ptr_StorageBuffer__ptr_PhysicalStorageBuffer_CommandBuffer %addresses %int_0
        %197 = OpLoad %_ptr_PhysicalStorageBuffer_CommandBuffer %196
        %198 = OpLoad %uint %id
        %199 = OpLoad %bool %is_visible
        %200 = OpSelect %int %199 %int_1 %int_0
        %201 = OpBitcast %uint %200
        %203 = OpAccessChain %_ptr_PhysicalStorageBuffer_uint %197 %int_0 %198 %int_1
