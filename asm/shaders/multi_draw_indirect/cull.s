...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %183 "param"
               OpName %184 "param"
               OpName %188 "VkDrawIndexedIndirectCommand"
               OpMemberName %188 0 "indexCount"
               OpMemberName %188 1 "instanceCount"
               OpMemberName %188 2 "firstIndex"
               OpMemberName %188 3 "vertexOffset"
               OpMemberName %188 4 "firstInstance"
               OpName %190 "CommandBuffer"
               OpMemberName %190 0 "commands"
               OpName %192 "command_buffer"
               ...
               OpDecorate %141 BufferBlock
               OpDecorate %143 DescriptorSet 0
               OpDecorate %143 Binding 0
               OpMemberDecorate %188 0 Offset 0
               OpMemberDecorate %188 1 Offset 4
               OpMemberDecorate %188 2 Offset 8
               OpMemberDecorate %188 3 Offset 12
               OpMemberDecorate %188 4 Offset 16
               OpDecorate %189 ArrayStride 20
               OpMemberDecorate %190 0 NonReadable
               OpMemberDecorate %190 0 Offset 0
               OpDecorate %190 BufferBlock
               OpDecorate %192 DescriptorSet 0
               OpDecorate %192 Binding 3
               OpDecorate %200 BuiltIn WorkgroupSize
          %2 = OpTypeVoid
          %3 = OpTypeFunction %2
          %6 = OpTypeFloat 32
          %7 = OpTypeVector %6 4
        ...
        %142 = OpTypePointer Uniform %141
        %143 = OpVariable %142 Uniform
        %144 = OpConstant %82 0
        %146 = OpTypePointer Uniform %139
        %154 = OpConstant %82 2
        %159 = OpConstant %82 4
        %162 = OpConstant %82 5
        %165 = OpConstant %82 6
        ...
        %188 = OpTypeStruct %20 %20 %20 %82 %20
        %189 = OpTypeRuntimeArray %188
        %190 = OpTypeStruct %189
        %191 = OpTypePointer Uniform %190
        %192 = OpVariable %191 Uniform
        %198 = OpConstant %20 64
        %199 = OpConstant %20 1
        %200 = OpConstantComposite %118 %198 %199 %199
        ...
        %193 = OpLoad %20 %117
        %194 = OpLoad %13 %171
        %195 = OpSelect %82 %194 %83 %144
        %196 = OpBitcast %20 %195
        %197 = OpAccessChain %129 %192 %144 %193 %83
               OpStore %197 %196
               OpReturn
               OpFunctionEnd
