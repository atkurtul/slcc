...
%float_0_00400000019 = OpConstant %float 0.00400000019
...
%samplerColor0 = OpVariable %_ptr_UniformConstant_21 UniformConstant
  ...
  %indexable = OpVariable %_ptr_Function__arr_float_uint_25 Function
         ...
         %48 = OpFMul %float %46 %float_0_00400000019
         ...
         %68 = OpFMul %float %67 %float_0_00400000019
        ...
        %100 = OpVectorTimesScalar %v4float %98 %float_0_600000024
        %101 = OpLoad %v4float %color
        %102 = OpFAdd %v4float %101 %100
               OpStore %color %102
               OpBranch %60
         %60 = OpLabel
        %103 = OpLoad %int %i
